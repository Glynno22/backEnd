...
public class IEnseignantServiceImpl implements IEnseignantService {
    ...
    @Override
    public List<Enseignant> findEnseignantByCne(String cne) {
        // 1. Trouve les User correspondants au CNE
        return userRepository.findByCne(cne); // Supposons que tu as cette méthode
    }
